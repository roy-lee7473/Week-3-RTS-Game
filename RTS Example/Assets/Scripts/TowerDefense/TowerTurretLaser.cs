...
//RaycastHit hit;
//if (Physics.Raycast(muzzle.transform.position, directionToTarget.normalized, out hit, maxDistance))
//{
//    if (!(hit.collider && !hit.collider.CompareTag("Enemy")))
//    {
//        distanceToExit = Mathf.Infinity;  //skip it, something in the way
//    }
//}